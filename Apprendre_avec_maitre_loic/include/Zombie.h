...
// j'ai mis la fonction direct dans la focntion de combat donc pas obligé de l'appeler à chaque fois void Show_stat_after_fight(); // on crée une fcontion pour avoir les stats après le fight du coup c'est cool
